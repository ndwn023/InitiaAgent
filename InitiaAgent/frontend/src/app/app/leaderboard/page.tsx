  ...
  return (
    ...
    >
      ...
      <div className="hidden sm:flex items-center gap-6 shrink-0 text-right">
        <div>
          <div className="text-[10px] text-zinc-600 mb-0.5 uppercase tracking-wider">Capital</div>
          <div className="text-sm font-mono text-emerald-400">
            {agent.initialCapital.toLocaleString(undefined, { maximumFractionDigits: 0 })}
          </div>
        </div>
        <div>
          <div className="text-[10px] text-zinc-600 mb-0.5 uppercase tracking-wider">Subscribers</div>
          <div className="text-sm font-mono text-zinc-300">{subscribers}</div>
        </div>
        <div>
    ...
    <div className="p-4 md:p-8 max-w-3xl mx-auto">
        ...
        >
          <div>
            ...
            <p className="mt-2 text-zinc-600 text-sm">
              Top agents ranked by capital deployed on Initia evm-1.
            </p>
          </div>
      ...
      {!isLoading && agents.length > 0 && (
        <div className="flex items-center gap-4 px-4 mb-3">
          ...
          <div className="hidden sm:flex items-center gap-6 shrink-0 text-right">
            <div className="w-16 text-[10px] text-zinc-700 uppercase tracking-wider">Capital</div>
            <div className="w-16 text-[10px] text-zinc-700 uppercase tracking-wider">Subs</div>
