export const AgentExecutorABI = [
  ...
  },
  {
    ...
    inputs: [],
    outputs: [
      { name: "", type: "address", internalType: "contract IInitiaDEX" },
    ],
    stateMutability: "view",
  },
  {
  ...
  {
    type: "error",
    name: "AgentExecutor__AgentNotActive",
    inputs: [{ name: "agentId", type: "uint256", internalType: "uint256" }],
  },
  {
    type: "error",
    name: "AgentExecutor__DeadlineExpired",
    inputs: [
      { name: "deadline", type: "uint256", internalType: "uint256" },
      { name: "blockTs", type: "uint256", internalType: "uint256" },
    ],
  },
  {
    type: "error",
    name: "AgentExecutor__InvalidDEX",
    inputs: [{ name: "dex", type: "address", internalType: "address" }],
  },
  {
    type: "error",
    name: "AgentExecutor__InvalidRegistry",
    inputs: [{ name: "registry", type: "address", internalType: "address" }],
  },
  {
    type: "error",
    name: "AgentExecutor__NotAuthorizedRunner",
    inputs: [
  ...
  {
    type: "error",
    name: "AgentExecutor__NotCreator",
    inputs: [
      { name: "caller", type: "address", internalType: "address" },
      { name: "agentId", type: "uint256", internalType: "uint256" },
    ],
  ...
  {
    type: "error",
    name: "AgentExecutor__RunnerAlreadyAuthorized",
    inputs: [
      { name: "runner", type: "address", internalType: "address" },
      { name: "agentId", type: "uint256", internalType: "uint256" },
    ],
  ...
  {
    type: "error",
    name: "AgentExecutor__RunnerNotAuthorized",
    inputs: [
      { name: "runner", type: "address", internalType: "address" },
      { name: "agentId", type: "uint256", internalType: "uint256" },
    ],
  ...
  {
    type: "error",
    name: "AgentExecutor__SameToken",
    inputs: [{ name: "token", type: "address", internalType: "address" }],
  },
  {
    type: "error",
    name: "AgentExecutor__SlippageExceeded",
    inputs: [
