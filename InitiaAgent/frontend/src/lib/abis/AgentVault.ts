export const AgentVaultABI = [
  ...
  {
    type: "error",
    name: "AgentVault__CooldownNotElapsed",
    inputs: [
  ...
  {
    type: "error",
    name: "AgentVault__DepositCapExceeded",
    inputs: [
  ...
  {
    type: "error",
    name: "AgentVault__ExceedsMaxTradePercent",
    inputs: [
  ...
  {
    type: "error",
    name: "AgentVault__InsufficientAssets",
    inputs: [
  ...
  {
    type: "error",
    name: "AgentVault__InsufficientShares",
    inputs: [
      { name: "requested", type: "uint256", internalType: "uint256" },
      { name: "available", type: "uint256", internalType: "uint256" },
    ],
  ...
  {
    type: "error",
    name: "AgentVault__IntervalTooShort",
    inputs: [
  ...
  {
    type: "error",
    name: "AgentVault__InvalidParam",
    inputs: [{ name: "param", type: "string", internalType: "string" }],
  },
  {
    type: "error",
    name: "AgentVault__MaxTradePercentOutOfRange",
    inputs: [{ name: "bps", type: "uint256", internalType: "uint256" }],
  },
  {
    type: "error",
    name: "AgentVault__NotCreator",
    inputs: [{ name: "caller", type: "address", internalType: "address" }],
  },
  {
    type: "error",
    name: "AgentVault__NotExecutor",
    inputs: [{ name: "caller", type: "address", internalType: "address" }],
  },
  {
    type: "error",
    name: "AgentVault__NotSplitter",
    inputs: [{ name: "caller", type: "address", internalType: "address" }],
  },
  { type: "error", name: "AgentVault__SplitterAlreadySet", inputs: [] },
  {
    type: "error",
    name: "AgentVault__TokenNotWhitelisted",
    inputs: [{ name: "token", type: "address", internalType: "address" }],
  },
  {
    type: "error",
    name: "AgentVault__UnauthorizedReconciler",
    inputs: [{ name: "caller", type: "address", internalType: "address" }],
  },
